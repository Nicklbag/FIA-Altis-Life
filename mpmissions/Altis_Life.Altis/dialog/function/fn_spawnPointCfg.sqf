...
switch (_side) do
{
	case west:
	{
		_return = [
			...
			["cop_spawn_kilo","Kontrolle","\a3\ui_f\data\map\GroupIcons\badge_rotate_0_gs.paa"],
			["cop_spawn_zulu","Kontrolle","\a3\ui_f\data\map\GroupIcons\badge_rotate_0_gs.paa"],
			["cop_spawn_bane","Kontrolle","\a3\ui_f\data\map\GroupIcons\badge_rotate_0_gs.paa"]
		];
	};
