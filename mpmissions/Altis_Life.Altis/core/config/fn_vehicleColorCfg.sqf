...
switch (_vehicle) do
{
	...
	case "C_Hatchback_01_sport_F":
	{
		...
		[
			...
			["Skins\hatchback_Polizei.paa","cop"]
	...
	case "C_Offroad_01_F":
	{
		...
		[
			...
			["Skins\police_offroad.paa","cop"],
			["Skins\offroad_notarzt.paa","med"]
	...
	case "C_SUV_01_F":
	{
		...
		[
			...
			["#(ai,64,64,1)Fresnel(1.3,7)","cop"],
			["Skins\cop_suv.paa","cop"],
			["Skins\suv_medik.paa","med"]
		];
	};
	...
	case "B_Heli_Light_01_F":
	{
		...
		[
			...
			["Skins\Notarzt_Hummingbird.paa","med"],
			["Skins\Polizei_Hummingbird.paa","cop"]
	...
	case "B_MRAP_01_F":
	{
		...
		[
			...
			["Skins\gh_polizei_front.paa","cop","Skins\gh_polizei_hinten.paa"]
		];
	};
	...
	case "B_MRAP_01_hmg_F":
	{
		_ret = 
		[
			["Skins\hunter_polizei_front1.paa","cop","Skins\hunter_polizei_hinten1.paa"]
		];
	};
