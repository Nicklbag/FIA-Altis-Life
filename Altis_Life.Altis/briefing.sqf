...
player createDiarySubject ["Tastaturbelegung","Steuerung"];
	...
	player createDiaryRecord ["policerules",
		[
			"Aviation",
				"
				Alle Regeln findest du in unserem Forum ! www.HOMEPAGE_URL!<br/>
				Helicopters cannot hover over the city. Cops may only hover over the city if there is an active police operation going on.<br/><br/>
				"
		]
	];
...
// Controls Section
	...
	player createDiaryRecord ["Tastaturbelegung",
		[
			"Tastenbelegung",
				"
				Z: Spieler Menü<br/>
